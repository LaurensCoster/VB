...
def hello_http(request):
    ...
    try:
        ...
        return jsonify({"error": "Invalid JSON format in room parameter"}), 400
    ...
    else_parameters_general = ['ksztalt_zacieku', 'miejsce_zacieku', 'wymiary_zacieku']
    else_parameters_ceiling = ['halogeny_ilosc', 'miejsce_sufit', 'inne_sufit']
    else_parameters_wall = ['inne_sciana', 'rodzaj_farby', 'kolor_farby', 'wysokosc_kafelki']
    ...
    null_parameters = [
        'nazwa_pomieszczenia', 'dlugosc', 'szerokosc', 'wysokosc', 'ksztalt_zacieku', 'miejsce_zacieku',
        'wymiary_zacieku', 'czy_mienie',
        ...
        'wykonczenie_podloga', 'wykladzina', 'panele', 'inne_podloga',
        'rodzaj_drzwi', 'uszkodzenia_drzwi', 'szerkosc_drzwi', 'wysokosc_drzwi', 'grubosc_drzwi',
    ]
    ...
    if tag == "disconnected" or session_params["loop_counter"] >= int(session_params["ilosc_pomieszczen"] + 1):
